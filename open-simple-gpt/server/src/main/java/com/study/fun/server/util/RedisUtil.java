...
public class RedisUtil {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            log.error("redisUtil expire {}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean hasKey(String key) {
        try {
            ...
            log.error("redisUtil hasKey {}", e.getMessage());
            return false;
        }
    }
    ...
    public boolean set(String key, Object value) {
        try {
            ...
            log.error("redisUtil set {}", e.getMessage());
            e.printStackTrace();
            return false;
        }
    ...
    public void pfAdd(String key, byte[]... bytes) {
        redisTemplate.execute((RedisCallback<Long>) con -> con.pfAdd(key.getBytes(), bytes));
    }
